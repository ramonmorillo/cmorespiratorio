...
for (const f of ['index.html','src/clinical.js','src/extractor.js','src/app.js','src/storage.js','src/workflow.js','src/styles.css']) if(!fs.existsSync(f)) throw new Error(`Missing ${f}`);
